...
{
    public class ClickLeftSegmentShort : IGestureSegment
    {
    ...
    public class ClickLeftSegmentFar : IGestureSegment
    {
        public bool Update(Body body)
        {
            if(body.HandLeftState != HandState.Closed)
            ...
            if (handLeft.Z < body.Joints[JointType.ElbowLeft].Position.Z
                ...
                && handLeft.X < body.Joints[JointType.ShoulderRight].Position.X)
            {
                GestureGlobals.s_ShoulderYPos = body.Joints[JointType.SpineShoulder].Position.Y;
                return true;
            }
            return false;
        }
    ...
    public class ClickRightSegmentShort : IGestureSegment
    {
        public bool Update(Body body)
        {
    ...
    public class ClickRightSegmentFar : IGestureSegment
    {
        public bool Update(Body body)
        {
            if (body.HandRightState != HandState.Closed)
